...
function QH.ReloadAddonLanguage(locale)
    if locale == "ru" then
        ...
        QH.Locale.SettingsEnableBackupToChatTooltip = "Вам будут приходить сообщениях от вас самих с id квестов в чате. Если игра вылетит, вы сможете восстановить историю по сообщениям из World of Warcraft/_retail_/Logs/WowChat.log. Но этот способ тоже не дает 100% гарантии"
        ...
        QH.Locale.SettingsExportBackupSession = "Экспортировать бекап сессий"
        QH.Locale.SettingsExportBackupSessionTooltip = "Экспортировать несортированный список id квестов за прошлые сесси. Может быть полезно если ваша игра вылетела"
        ...
        QH.Locale.SettingsEnableBackupToChatTooltip = "You will see messages from yourself in chat with ids of quests. If you game crashes you will be able to restore the history using World of Warcraft/_retail_/Logs/WowChat.log. But there is also no guarantee that it will be saved on disk"
        ...
        QH.Locale.SettingsExportBackupSession = "Export backup of sessions"
        QH.Locale.SettingsExportBackupSessionTooltip = "Export unsorted ids of previous sessions. Might be useful if you game or system crashed"
